      ...
      <section class="research-area reveal-on-scroll">
        ...
        <div class="image-slider" id="slider">
          <div class="slider-container">
            ...
            />
            <img
              src="/src/gallery/25/250109_7.jpg"
              alt="Photo 2"
              class="slider-image"
            />
            <img
              src="/src/gallery/25/250109_2.jpg"
              alt="Photo 3"
              class="slider-image"
            />
          </div>
      ...
      <section class="lab-info reveal-on-scroll">
        <div class="text-container">
          ...
          <div class="reveal-on-scroll">
            ...
            <p></p>
            <li>
              <strong>Main Software</strong> TeX, Gauss, Arena, Siman, Cplex,
              Xpress-MP, Lindo, Lingo, etc.
            </li>
            <p></p>
            <li>
              <strong>Main Programming Languages</strong> Visual Basic, Delphi,
              C, C++, Visual C++, Java, Python, C#, API, MS SQL, .NET, EJB,
              Access, etc.
            </li>
          </div>
        </div>
